% Plotting Script for HW2 Task 2-1 
...
fig = figure('Name', 'Task 2-1: Muscle Driven Walker', 'Color', 'w', 'Position', [100 50 800 900]);


% --- Subplot 1: Trunk Angle (REQUIRED) ---
ax1 = subplot(5,1,1);
plot(out.log_theta.Time, out.log_theta.Data * 180/pi, 'k', 'LineWidth', 2);
ylabel('\theta [deg]', 'FontWeight', 'bold', 'Color', 'k');
title('Task 2-1: Trunk Angle', 'FontWeight', 'bold', 'Color', 'k');
grid on;
